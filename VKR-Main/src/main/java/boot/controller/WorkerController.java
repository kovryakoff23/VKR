...
public class WorkerController {
    ...
    @Autowired
    public WorkerController(WorkerService workerService, PricingWorkerService pricingWorkerService,
                            SalaryService salaryService, SalaryWorkerService salaryWorkerService) {
